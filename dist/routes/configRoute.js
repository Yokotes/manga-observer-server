...
configRoute.post('/config', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var configManager, config;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                configManager = store_1["default"].getState().configManager.configManager;
                config = req.body;
                if (!config) {
                    res.sendStatus(400);
                    return [2 /*return*/];
                }
                return [4 /*yield*/, configManager.writeToConfigs(config)];
            case 1:
                _a.sent();
